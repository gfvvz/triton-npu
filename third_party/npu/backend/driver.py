...
llvm_root = os.getenv("LLVM_SYSPATH", default="~/.triton/llvm")
...
class NPUUtils(object):
    ...
    def __init__(self):
        ...
        mod = compile_module_from_src(Path(os.path.join(dirname, "driver.cpp")).read_text(), "npu_utils")
...
static struct PyModuleDef ModuleDef = {{
  ...
  \"__triton_npu_launcher\",
  NULL, //documentation
  -1, //size
  ModuleMethods
}};

PyMODINIT_FUNC PyInit___triton_npu_launcher(void) {{
...
class NPULauncher(object):
    def __init__(self, src, metadata):
        ...
        mod = compile_module_from_src(src, "__triton_npu_launcher")

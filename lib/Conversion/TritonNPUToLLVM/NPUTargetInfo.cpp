#include "triton/Conversion/TritonNPUToLLVM/NPUTargetInfo.h"
...
Value NPUTargetInfo::programId(ConversionPatternRewriter &rewriter,
                               Location loc, LLVM::LLVMFuncOp funcOp,
                               int axis) const {
  assert(axis >= 0 && axis < 3);

  // program_id for NPU is provided as function arguments. The last three
...
void NPUTargetInfo::printf(ConversionPatternRewriter &rewriter,
